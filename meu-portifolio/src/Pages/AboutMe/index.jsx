    ...
    return (
        <div className="flex flex-col gap-12 ml-5 mb-5 p-6">
            ...
            <div className="flex justify-around items-center">
                <p className="text-lg w-2/4">Me chamo Vinicius, tenho 23 anos e moro em São João da Boa Vista, uma pequena cidade no interior de São Paulo.
            ...
            <div className="flex justify-around items-center">
                <p className="text-lg w-2/4">Eu sempre gostei de computação, tanto que meu fiz primeiro curso de informática básica aos 10 anos
                ...
                no Instituto Federal de Educação, Ciência e Tecnologia. Sou muito grato por todos os conhecimentos e amizades que eu fiz pelo ao longo da minha recente
                vida academica. Um grande difencial do curso foi o conhecimento teórico adquirido. 
                coisas como Engenharia de Software, Projeto e Análise de Algoritmos, Linguagens Formais e Autômatos acabam sendo exemplos de conhecimentos que vão além do costumeiro prático que vemos por ai.
                </p>
            ...
            <div className="">
                ...
                e também começarei em breve um curso de Inglês, algo crucial nos tempos atuais.</p>
            </div>
            ...
            <div className="flex justify-around items-center">
                ...
                Além disso, eu também amo sair com a minha namorada, e o nosso principal rolê é o rolê eletrotico.</p>
            ...
            <div className="flex gap-4 justify-around items-center">
                <div class="avatar">
                    <div class="ring-primary ring-offset-base-100 w-24 rounded-full ring ring-offset-1">
                ...
                <div class="avatar">
                    <div class="ring-primary ring-offset-base-100 w-24 rounded-full ring ring-offset-1">
                        <img className="bg-white" src="/logos/logo_kanban.png" />
                    </div>
                </div>
                <div class="avatar">
                    <div class="ring-primary ring-offset-base-100 w-24 rounded-full ring ring-offset-1">
            ...
            <h3 className="text-xl list-item">Soft-Skills</h3>
